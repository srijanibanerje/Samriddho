...
import pro6 from "../assets/images/products/6.jpeg"
import pro7 from "../assets/images/products/7.jpeg"
const Product = () => {
  return (
    <>
        ...
        <div className="contain-product layout-default">
                                                    ...
                                                    <div className="info">
                                                        ...
                                                        <div className="price ">
                                                            ...
                                                            <del><span className="price-amount"><span className="currencySymbol">Rs.</span>95.00</span></del>
                                                        </div>
        ...
        <div className="contain-product layout-default">
                                                    ...
                                                    <div className="info" >
                                                        ...
                                                        <div class="price ">
                                                            ...
                                                            <del><span class="price-amount"><span className="currencySymbol">Rs.</span>95.00</span></del>
                                                        </div>
                                                        <div className="slide-down-box">
    ...
    <div className='col-lg-4 col-md-3 col-sm-6'>
        ...
        <div className="contain-product layout-default">
                                                    <div className="product-thumb">
                                                        <a href="#" className="link-to-product">
                                                            <img src={pro6} alt="Vegetables" width="370" height="270" className="product-thumnail"/>
                                                        </a>
                                                       
                                                    </div>
                                                    <div className="info" >
                                                       
                                                        <h4 className="product-title"><a href="#" className="pr-name">Kala Jeera, 100g</a></h4>
                                                        <div class="price ">
                                                            <ins><span class="price-amount"><span className="currencySymbol">Rs.</span>85.00</span></ins>
                                                            <del><span class="price-amount"><span className="currencySymbol">Rs.</span>95.00</span></del>
                                                        </div>
        ...
        <div className="contain-product layout-default">
                                                    <div className="product-thumb">
                                                        <a href="#" className="link-to-product">
                                                            <img src={pro7} alt="Vegetables" width="370" height="270" className="product-thumnail"/>
                                                        </a>
                                                       
                                                    </div>
                                                    <div className="info" >
                                                       
                                                        <h4 className="product-title"><a href="#" className="pr-name">Black Pepper, 100g</a></h4>
                                                        <div class="price ">
                                                            <ins><span class="price-amount"><span className="currencySymbol">Rs.</span>85.00</span></ins>
                                                            <del><span class="price-amount"><span className="currencySymbol">Rs.</span>95.00</span></del>
                                                        </div>
